...
- 시작, 저장, 종료 등 메인 화면을 구성하는 UI + 뒷 배경 제작 (완료)

<img src="./img/메뉴.JPG">   

 

- 캐릭터 컨셉아트 제작 (주인공 완료, 차후 다른 NPC 추가 예정)

<img src="./img/캐릭터 모션.JPG">   
<img src="./img/캐릭터 얼굴.JPG">   
...
- 작업명 : 초반 스토리, 두 번째 맵 제작

- 해당 요구사항 : 스토리 작성, 맵 제작

- 게임 시작 후 첫 이벤트 생성
- 두 번째 맵으로 이동할 시 또 다른 이벤트 발생
- 아이템 획득

- 설명 : (구체적 작업 설명)

- 플레이어가 진행할 두 번째 맵을 도트로 이용해 제작한다
- 이벤트 생성, 변수 추가
